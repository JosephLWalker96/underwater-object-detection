...
case ${ADAPT_MODE} in
  ...
  TAK2PAL_CycleGAN)
    ...
    TRAIN_IMDB_T="TAK_synthPALtrain+TAK_synthPALval"
  ...
  TAK2PAL_cm)
    TRAIN_IMDB_S="TAK_train+TAK_val"
    TRAIN_IMDB_T="TAKsynth_PALtrain+TAKsynthPAL_val"
    TEST_IMDB="PAL_trainval"
    ITERS=${TEST_ITER}
    STEPSIZE="[50000]"
    ANCHORS="[4,8,16,32]"
  ...
  TAK2PAL2021_cm)
    TRAIN_IMDB_S="TAK_train+TAK_val"
    TRAIN_IMDB_T="TAKsynthPAL_2021train+TAKsynthPAL2021_val"
    TEST_IMDB="PAL2021_trainval"
    ITERS=${TEST_ITER}
    STEPSIZE="[50000]"
    ANCHORS="[4,8,16,32]"
  ...
  TAK2HUA_CycleGAN)
    TRAIN_IMDB_S="TAK_train+TAK_val"
    TRAIN_IMDB_T="TAKsynthHUA_train+TAKsynthHUA_val"
    TEST_IMDB="HUA_trainval"
    ITERS=${TEST_ITER}
    STEPSIZE="[50000]"
    ANCHORS="[4,8,16,32]"
