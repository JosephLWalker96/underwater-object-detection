...
if __name__ == "__main__":
    ...
    print("Please Enter The Path To Images Folder For Testing")
    ...
    while not os.path.exists(path_to_images):
        ...
        print("Please Re-Enter The Path To Images For Testing")
        path_to_images = input()
        print("You Just Enter: " + path_to_images)
    ...
    for images, targets, image_ids in tqdm(data_loader):
        ...
        for i in range(patch_size):
            ...
            img_folder = path_to_images + "/" + str(records["Location"].values[0]) + "/" + str(records["Camera"].values[0]) 
