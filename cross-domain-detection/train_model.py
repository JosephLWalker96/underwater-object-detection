...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_type', default='suit',
                        choices=opt.data_types)
    parser.add_argument('--det_type', choices=opt.detectors, default='faster')
    parser.add_argument('--resume',
                        help='path of the model to resume from')
    parser.add_argument('--load', 
                        # default='results/TAK/model_iter_60000',
                        default=None,
                        help='load original trained model')
    ...
    train_iter = MultiprocessIterator(train, args.batchsize, n_processes=12,
